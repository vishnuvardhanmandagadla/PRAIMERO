...
import ERPModel3D from '../../components/ServiceModels/ERPModel3D'
...
function ERPPage() {
  const service = services.find(s => s.id === 'erp')
        ...
        <div className="container">
          ...
          >
            ...
            <motion.h1 className="sp__title" variants={fadeUp}>
              Oracle ERP
              <em> Intelligence Suite</em>
            </motion.h1>
            <motion.p className="sp__desc" variants={fadeUp}>
              End-to-end enterprise resource planning powered by machine learning, automation, and real-time analytics.
            </motion.p>
            <motion.div className="sp__tags" variants={fadeUp}>
              <span className="sp__tag">Finance</span>
              <span className="sp__tag">Supply Chain</span>
              <span className="sp__tag">HCM</span>
              <span className="sp__tag">Analytics</span>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="sp__modules section">
        ...
        <div className="container">
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            Intelligent <em>Platform Components</em>
          </motion.h2>
